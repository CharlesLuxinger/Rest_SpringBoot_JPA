package com.charlesluxinger.money.api.security;
...
import com.charlesluxinger.money.api.model.Usuario;
import com.charlesluxinger.money.api.repository.UsuarioRepository;
...
public class AppUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		Usuario user = userByEmail.orElseThrow(() -> new UsernameNotFoundException("Usuário e/ou senha incorretos"));
